...
export const mappingToFormValues = (mapping: IMapping): IMappingFormValues => {
  ...
  return {
    ...
    url,
    urlMatchType,
    queryParameters: mappingRequestParamsToFormValue(
    ...
    requestBodyPatterns: mappingRequestBodyPatternsToFormValue(
...
export const mappingRequestParamsFormValueToRequestParams = (
  ...
  return params.reduce(
    (
      agg: IMappingRequestParams,
      param: IMappingRequestParamFormValue,
    ): IMappingRequestParams => {
      return {
        ...agg,
        [param.key]: {
...
export const mappingRequestBodyPatternsFormValueToBodyPatterns = (
  ...
  return bodyPatterns.map(
    (
      bodyPattern: IMappingRequestBodyPatternFormValue,
    ): IMappingRequestBodyPattern => ({
...
export const mappingFormValuesToMapping = (
  formValues: IMappingFormValues,
): IMapping => {
  ...
  const mapping: IMapping = {
    ...
    priority:
      formValues.priority === 'auto' ? undefined : Number(formValues.priority),
    request: {
