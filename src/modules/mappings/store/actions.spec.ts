...
describe('syncMappingWorkingCopy', () => {
  it('should return corresponding action', () => {
    expect(
      syncMappingWorkingCopy(testServer.name, testMapping.id, testMapping),
    ).toEqual({
...
describe('updateMappingRequest', () => {
  it('should return corresponding action', () => {
    expect(
      updateMappingRequest(testServer.name, testMapping.id, testMapping),
    ).toEqual({
...
describe('updateMappingSuccess', () => {
  it('should return corresponding action', () => {
    expect(
      updateMappingSuccess(testServer.name, testMapping.id, testMapping),
    ).toEqual({
