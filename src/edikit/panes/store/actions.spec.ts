...
describe('removePaneContentAction', () => {
  it('should return corresponding action', () => {
    expect(
      removePaneContentAction('namespace', 'pane_id', 'content_id'),
    ).toEqual({
...
describe('setPaneCurrentContentAction', () => {
  it('should return corresponding action', () => {
    expect(
      setPaneCurrentContentAction('namespace', 'pane_id', 'content_id'),
    ).toEqual({
...
describe('splitPaneAction', () => {
  it('should return corresponding action', () => {
    expect(
      splitPaneAction('namespace', 'pane_id', PaneSplitAxis.Horizontal),
    ).toEqual({
